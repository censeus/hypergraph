...
class LLMCompletionResponse(ChatCompletion, Generic[ResponseFormat]):
    ...
    The response type returned by hypergraph-llm LLMCompletionFunction.
    hypergraph-llm automatically handles structured response parsing based on the
...
class LLMEmbeddingResponse(CreateEmbeddingResponse):
    ...
    The response type returned by hypergraph-llm LLMEmbeddingFunction.
