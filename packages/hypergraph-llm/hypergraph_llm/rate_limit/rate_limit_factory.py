...
from hypergraph_llm.config import RateLimitType
from hypergraph_llm.rate_limit.rate_limiter import RateLimiter

if TYPE_CHECKING:
    from hypergraph_common.factory import ServiceScope

    from hypergraph_llm.config import RateLimitConfig
    ...
    if strategy not in rate_limit_factory:
        match strategy:
            case RateLimitType.SlidingWindow:
                from hypergraph_llm.rate_limit.sliding_window_rate_limiter import (
