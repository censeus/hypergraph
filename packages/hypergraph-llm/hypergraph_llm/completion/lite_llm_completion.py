...
from hypergraph_llm.config.types import AuthMethod
from hypergraph_llm.middleware import (
...
def _create_base_completions(
    *,
    ...
    Convert litellm completion functions to hypergraph_llm LLMCompletionFunction.
    LLMCompletionFunction is close to the litellm completion function signature,
    but uses a few extra params such as metrics. Remove hypergraph_llm LLMCompletionFunction
