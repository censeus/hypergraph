...
from hypergraph_llm.config.types import TemplateEngineType
from hypergraph_llm.templating.template_engine import TemplateEngine
from hypergraph_llm.templating.template_manager_factory import create_template_manager
    ...
    if strategy not in template_engine_factory:
        match strategy:
            case TemplateEngineType.Jinja:
                from hypergraph_llm.templating.jinja_template_engine import (
                    JinjaTemplateEngine,
                )
