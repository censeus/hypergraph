...
from hypergraph_llm.threading.embedding_thread_runner import embedding_thread_runner
...
if TYPE_CHECKING:
    ...
    from hypergraph_llm.threading.embedding_thread_runner import (
        ThreadedLLMEmbeddingFunction,
        ThreadedLLMEmbeddingResponseHandler,
    )
    from hypergraph_llm.tokenizer import Tokenizer
    from hypergraph_llm.types import LLMEmbeddingArgs, LLMEmbeddingResponse
