...
def create_embedding(
    ...
    *,
    ...
    if strategy not in embedding_factory:
        match strategy:
            case LLMProviderType.LiteLLM:
                from hypergraph_llm.embedding.lite_llm_embedding import (
                    LiteLLMEmbedding,
                )
            ...
            case LLMProviderType.MockLLM:
                from hypergraph_llm.embedding.mock_llm_embedding import MockLLMEmbedding
    ...
    if model_config.metrics:
        from hypergraph_llm.metrics import (
