...
from hypergraph_llm.config.types import MetricsWriterType
    ...
    if strategy not in metrics_writer_factory:
        match strategy:
            case MetricsWriterType.Log:
                from hypergraph_llm.metrics.log_metrics_writer import LogMetricsWriter
            ...
            case MetricsWriterType.File:
                from hypergraph_llm.metrics.file_metrics_writer import FileMetricsWriter
