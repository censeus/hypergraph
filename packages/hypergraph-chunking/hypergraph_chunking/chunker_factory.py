...
from hypergraph_common.factory.factory import Factory, ServiceScope

from hypergraph_chunking.chunk_strategy_type import ChunkerType
from hypergraph_chunking.chunker import Chunker
    ...
    if chunker_strategy not in chunker_factory:
        match chunker_strategy:
            case ChunkerType.Tokens:
                from hypergraph_chunking.token_chunker import TokenChunker

                register_chunker(ChunkerType.Tokens, TokenChunker)
            case ChunkerType.Sentence:
                from hypergraph_chunking.sentence_chunker import SentenceChunker
