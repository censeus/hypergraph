...
from hypergraph_common.factory import Factory, ServiceScope
...
from hypergraph_storage.tables.table_type import TableType
    ...
    if table_type not in table_provider_factory:
        match table_type:
            case TableType.Parquet:
                from hypergraph_storage.tables.parquet_table_provider import (
                    ParquetTableProvider,
                )

                register_table_provider(TableType.Parquet, ParquetTableProvider)
            case TableType.CSV:
                from hypergraph_storage.tables.csv_table_provider import (
                    CSVTableProvider,
                )
