...
from hypergraph.index.operations.build_noun_graph.build_noun_graph import build_noun_graph
from hypergraph.index.operations.build_noun_graph.np_extractors.base import (
    BaseNounPhraseExtractor,
)
from hypergraph.index.operations.build_noun_graph.np_extractors.factory import (
