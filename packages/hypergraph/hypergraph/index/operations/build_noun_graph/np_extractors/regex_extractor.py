...
from hypergraph.index.operations.build_noun_graph.np_extractors.resource_loader import (
...
class RegexENNounPhraseExtractor(BaseNounPhraseExtractor):
    ...
    def __init__(
        ...
        NOTE: This is the extractor used in the first bencharmking of LazyHypergraph but it only works for English.
