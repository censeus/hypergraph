...
from hypergraph.index.typing.error_handler import ErrorHandlerFn
from hypergraph.prompts.index.extract_claims import (
    CONTINUE_PROMPT,
    LOOP_PROMPT,
)
...
class ClaimExtractor:
    ...
    def __init__(
        ...
        self._max_gleanings = (
            ...
            else hypergraph_config_defaults.extract_claims.max_gleanings
        )
