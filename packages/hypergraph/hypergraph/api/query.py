...
This API provides access to the query engine of hypergraph, allowing external applications
to hook into hypergraph and run queries over a knowledge graph generated by hypergraph.
...
from hypergraph.query.factory import (
    get_basic_search_engine,
    get_drift_search_engine,
    get_global_search_engine,
    get_local_search_engine,
)
from hypergraph.query.indexer_adapters import (
...
from hypergraph.utils.api import (
    get_embedding_store,
    load_search_prompt,
    truncate,
)
...
async def global_search(
    ...
    Parameters
    ----------
    - config (HyperGraphConfig): A hypergraph configuration (from settings.yaml)
