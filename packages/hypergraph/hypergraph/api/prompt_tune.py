...
This API provides access to the auto templating feature of hypergraph, allowing external applications
to hook into hypergraph and generate prompts from private data.
...
from hypergraph.prompt_tune.defaults import MAX_TOKEN_COUNT, PROMPT_TUNING_MODEL_ID
from hypergraph.prompt_tune.generator.community_report_rating import (
    generate_community_report_rating,
)
from hypergraph.prompt_tune.generator.community_report_summarization import (
    create_community_summarization_prompt,
)
from hypergraph.prompt_tune.generator.community_reporter_role import (
    generate_community_reporter_role,
)
from hypergraph.prompt_tune.generator.domain import generate_domain
from hypergraph.prompt_tune.generator.entity_relationship import (
    generate_entity_relationship_examples,
)
from hypergraph.prompt_tune.generator.entity_summarization_prompt import (
    create_entity_summarization_prompt,
)
from hypergraph.prompt_tune.generator.entity_types import generate_entity_types
from hypergraph.prompt_tune.generator.extract_graph_prompt import (
    create_extract_graph_prompt,
)
from hypergraph.prompt_tune.generator.language import detect_language
from hypergraph.prompt_tune.generator.persona import generate_persona
...
async def generate_indexing_prompts(
    ...
    Parameters
    ----------
    - config: The HyperGraph configuration.
