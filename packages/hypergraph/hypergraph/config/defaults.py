...
from hypergraph_cache import CacheType
from hypergraph_chunking.chunk_strategy_type import ChunkerType
from hypergraph_input import InputType
from hypergraph_llm.config import AuthMethod
from hypergraph_storage import StorageType
from hypergraph_vectors import VectorStoreType

from hypergraph.config.embeddings import default_embeddings
from hypergraph.config.enums import (
    AsyncType,
...
@dataclass
class HyperGraphConfigDefaults:
    """Default values for Hypergraph."""
...
hypergraph_config_defaults = HyperGraphConfigDefaults()
