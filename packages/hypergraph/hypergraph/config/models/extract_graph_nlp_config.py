...
from hypergraph.config.enums import AsyncType, NounPhraseExtractorType
...
class TextAnalyzerConfig(BaseModel):
    ...
    extractor_type: NounPhraseExtractorType = Field(
        ...
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.extractor_type,
    )
    model_name: str = Field(
        description="The SpaCy model name.",
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.model_name,
    )
    max_word_length: int = Field(
        description="The max word length for NLP parsing.",
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.max_word_length,
    )
    word_delimiter: str = Field(
        description="The delimiter for splitting words.",
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.word_delimiter,
    )
    include_named_entities: bool = Field(
        description="Whether to include named entities in noun phrases.",
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.include_named_entities,
    )
    exclude_nouns: list[str] | None = Field(
        ...
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.exclude_nouns,
    )
    exclude_entity_tags: list[str] = Field(
        description="The list of named entity tags to exclude in noun phrases.",
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.exclude_entity_tags,
    )
    exclude_pos_tags: list[str] = Field(
        description="The list of part-of-speech tags to remove in noun phrases.",
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.exclude_pos_tags,
    )
    noun_phrase_tags: list[str] = Field(
        description="The list of noun phrase tags.",
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.noun_phrase_tags,
    )
    noun_phrase_grammars: dict[str, str] = Field(
        ...
        default=hypergraph_config_defaults.extract_graph_nlp.text_analyzer.noun_phrase_grammars,
    )
...
class ExtractGraphNLPConfig(BaseModel):
    ...
    normalize_edge_weights: bool = Field(
        ...
        default=hypergraph_config_defaults.extract_graph_nlp.normalize_edge_weights,
    )
    ...
    concurrent_requests: int = Field(
        ...
        default=hypergraph_config_defaults.extract_graph_nlp.concurrent_requests,
    )
    async_mode: AsyncType = Field(
        description="The async mode to use.",
        default=hypergraph_config_defaults.extract_graph_nlp.async_mode,
    )
