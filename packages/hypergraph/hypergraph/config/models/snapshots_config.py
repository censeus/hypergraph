...
class SnapshotsConfig(BaseModel):
    ...
    embeddings: bool = Field(
        ...
        default=hypergraph_config_defaults.snapshots.embeddings,
    )
    graphml: bool = Field(
        description="A flag indicating whether to take snapshots of GraphML.",
        default=hypergraph_config_defaults.snapshots.graphml,
    )
    raw_graph: bool = Field(
        ...
        default=hypergraph_config_defaults.snapshots.raw_graph,
    )
