...
from hypergraph.prompts.index.community_report import COMMUNITY_REPORT_PROMPT
...
class CommunityReportsConfig(BaseModel):
    ...
    completion_model_id: str = Field(
        ...
        default=hypergraph_config_defaults.community_reports.completion_model_id,
    )
