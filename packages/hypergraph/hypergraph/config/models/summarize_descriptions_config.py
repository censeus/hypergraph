...
class SummarizeDescriptionsConfig(BaseModel):
    ...
    completion_model_id: str = Field(
        ...
        default=hypergraph_config_defaults.summarize_descriptions.completion_model_id,
    )
    model_instance_name: str = Field(
        ...
        default=hypergraph_config_defaults.summarize_descriptions.model_instance_name,
    )
    prompt: str | None = Field(
        description="The description summarization prompt to use.",
        default=hypergraph_config_defaults.summarize_descriptions.prompt,
    )
    max_length: int = Field(
        description="The description summarization maximum length.",
        default=hypergraph_config_defaults.summarize_descriptions.max_length,
    )
    max_input_tokens: int = Field(
        description="Maximum tokens to submit from the input entity descriptions.",
        default=hypergraph_config_defaults.summarize_descriptions.max_input_tokens,
    )
