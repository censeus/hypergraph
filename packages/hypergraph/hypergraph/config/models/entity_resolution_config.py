...
from hypergraph.prompts.index.entity_resolution import ENTITY_RESOLUTION_PROMPT
...
class EntityResolutionConfig(BaseModel):
    ...
    enabled: bool = Field(
        ...
        default=hypergraph_config_defaults.entity_resolution.enabled,
    )
    completion_model_id: str = Field(
        description="The model ID to use for entity resolution.",
        default=hypergraph_config_defaults.entity_resolution.completion_model_id,
    )
    model_instance_name: str = Field(
        ...
        default=hypergraph_config_defaults.entity_resolution.model_instance_name,
    )
    prompt: str | None = Field(
        description="The entity resolution prompt to use.",
        default=hypergraph_config_defaults.entity_resolution.prompt,
    )
