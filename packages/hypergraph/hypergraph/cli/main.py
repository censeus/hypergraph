...
from hypergraph.config.enums import IndexingMethod, SearchMethod
from hypergraph.prompt_tune.defaults import LIMIT, MAX_TOKEN_COUNT, N_SUBSET_MAX, K
from hypergraph.prompt_tune.types import DocSelectionType

INVALID_METHOD_ERROR = "Invalid method"

app = typer.Typer(
    help="Hypergraph: A graph-based retrieval-augmented generation (RAG) system.",
...
def _initialize_cli(
    ...
    from hypergraph.cli.initialize import initialize_project_at
...
def _update_cli(
    ...
    """
    from hypergraph.cli.index import update_cli
...
def _prompt_tune_cli(
    ...
    language: str | None = typer.Option(
        None,
        "--language",
        help="The primary language used for inputs and outputs in hypergraph prompts.",
    ),
    ...
    """Generate custom hypergraph prompts with your own data (i.e. auto templating)."""
    import asyncio

    from hypergraph.cli.prompt_tune import prompt_tune
...
def _query_cli(
    ...
    from hypergraph.cli.query import (
        run_basic_search,
        run_drift_search,
        run_global_search,
        run_local_search,
