...
We use an injectable InputReader provider class. This means you can implement any input file handling you want in a class that extends InputReader and register it with the InputReaderFactory. See the [architecture page](https://censeus.github.io/hypergraph/index/architecture/) for more info on our standard provider pattern.
